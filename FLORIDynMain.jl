...
#                             Stores the time & the power output of the
...
#    .pos       := [nx3] mat; x & y positions & nacelle height for all n
#                             turbines.
...
#    .Res       := [1x2] mat; x & y resolution of the interpolation mesh()
...
#    .FreeSpeed := bool;      OPs traveling with free wind speed | own
#                             speed
...
#                             | only the OPs at the rotor plane [true]
# ======================================================================= #
...
#   power constants [Efficiency, p_p], data to connect wind speed &
...
#       "const"                     -> Constant wind speed; direction &
#                                       amb. turbulence
...
## Create starting OPs & build opList
#   Creates the observation point struct (OP) & extends the chain struct.
...
#   changing over time; prepares the console progress output & sets
#   values for the turbines & observation points which may not be 0
...
for k = 1:Sim.NoTimeSteps
    ...
    # Set Ct/Cp & calculate the power output
    ControllerScript
    ...
    #====================== INCREMENT POSITION ===========================#
    # Update wind dir & speed along with amb. turbulence intensity
    ...
    # Calculate the down & crosswind steps along with the windspeed at
